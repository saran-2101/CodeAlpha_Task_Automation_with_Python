...
⚙️ How It Works
Read Source Folder - Scans all files in the source directory
Organize Files - Creates folders (Text Files, Images) and moves files based on extensions
Extract Emails - Opens .txt files and finds all Gmail addresses using regex
Remove Duplicates - Uses Python set to eliminate duplicate emails
Save Results - Writes unique emails to Email.txt in the output folder
